...
|---|---|---|---|---|---|
| QA-инженеры используют AI для генерации тест-кейсов из user stories | Рынок (State Street, DBS) + Визион | 8 | 7 | 3 | 168 |
...
*Несмотря на то что QA-гипотеза сильнее по рынку, доступ к ЦА равен 3 — запустить её сейчас невозможно.*
